      ...
      <div className={cx('profile')}>
        ...
        <ul>
          <li className={cx('profile__cont')}>
            <span><Image src="/images/icon_phone.png" alt="전화번호" width={134} height={23} />
            </span>
            <b>010-5914-0214</b>
          </li>
          <li className={cx('profile__cont')}>
            <span><Image src="/images/icon_global.png" alt="홈페이지 주소" width={134} height={23} />
            </span>
            <b>www.choihh.com</b>
          </li>
          <li className={cx('profile__cont')}>
            <span><Image src="/images/icon_mail.png" alt="메일주소" width={134} height={23} />
            </span>
            <a href="mailto:chlgkgp006@naver.com">
              chlgkgp006@naver.com
            </a>
          </li>
        </ul>
      </div>
